...
# Import libraries and data and do basic DESeq2 filtering
...
# Importing phenotypic data and filter gene expression based on variance
...
# Plot the dendograms for the modules
...
# Test for correlation between each eigengene of each module and the trait data
...
# Plot eigengene values by treatment and line conditions
...
# Assessed gene ontology in the significant modules
...
geneIDs_grey60 <- module.gene.mapping %>% filter(`bwnet$colors` == 'grey60') %>% rownames()

# Filter annotation for module genes -- change the name here
module_GO <- tonsa_go[tonsa_go$geneID %in% geneIDs_grey60, ]
