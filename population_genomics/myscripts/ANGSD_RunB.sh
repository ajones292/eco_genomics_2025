...
mkdir ~/projects/eco_genomics_2025/population_genomics/mydata/ANGSD_RunB

INPUT="/gpfs1/cl/ecogen/pbio6800/PopulationGenomics/bams"

OUT="/users/a/j/ajones76/projects/eco_genomics_2025/population_genomics/mydata/ANGSD_RunB"
