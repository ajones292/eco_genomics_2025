...
Re-make the PCA on just the red spruce samples after removing the black spruce
...
Test for correlation between Admixture scores from the red-black spruce analysis and the PC! scores from the red spruce only analysis. Is PC1 still an axis of introgression? Is there any evidence for introgression also along PC2
...
Now read in our selection stats and calculate p-values based on the Chi-Square distribution
...
Now make Manhattan plot for PC1 and PC2 separately:
